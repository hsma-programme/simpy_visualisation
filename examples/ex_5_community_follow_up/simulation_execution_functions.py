...
def single_run(args, rep=0):
    ...
    return model.results_all, model.results_low, model.results_high, model.event_log, model.bookings, model.available_slots, model.daily_caseload_snapshots, model.results_daily_arrivals
